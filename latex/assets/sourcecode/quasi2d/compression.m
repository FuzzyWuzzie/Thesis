function model = compression(dbConnection, caseIndex)
	% pull our data from our database
	...
	parameters = fetch(dbConnection, query);
	...
	if strcmpi(cell2mat(parameters.caseCategory), 'human') == 1
		...
		model.func('im1').set('filename', sprintf('/media/kenton/data/School/USEbrella/Programs/QuasiRedo/compression/stiffnessMap_%03d.png', caseIndex));
