	...
	\section{Method}
		...
		\subsection{Model Validation Using a Commercially Available Phantom}
			...
			\begin{table}[!htb]
				...
				\begin{tabular}{lcs[table-unit-alignment = left]}
					\toprule
					Property & Value & Units \\
					\midrule
					Nominal basal stiffness & 25 & \si{\kPa} \\
					Lesion stiffness &  $[8, 14, 45, 80]$ & \si{\kPa} \\
					Speed of sound & 1540 & \si{\metre\per\second} \\
					Acoustic attenuation & 0.5 & \si{\decibel\per\cm\per\MHz} \\
