...
\label{chap:litreview}
	...
	\section{Deep Tissue Injuries}
		...
		\subsection{Detection}
			...
			Recently, another possible avenue for DTI detection has arisen which lies in the biochemical markers present a patient's blood or urine. (look at gefen13 for references for this).

			\comment {
				Other papers to consider:
					\cite{salzberg96}: another PU risk assessment scale (for SCI)
					\cite{fromantin11}: another PU risk assessment scale (for oncology)
			}
