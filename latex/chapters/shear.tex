	...
	\label{subsec:shear_results}
		...
		\subsection{Lesion Detection Characterization}
			...
			\begin{figure}[!htb]
				...
				%\pgfplotstabletranspose[columns=esr, numeric type]{\transA}{assets/shear/data/shear_human_radius_r025.dat}
				%\pgfplotstabletranspose[columns=esr, numeric type]{\transB}{assets/shear/data/shear_human_radius_r050.dat}
				%\pgfplotstabletranspose[columns=esr, numeric type]{\transC}{assets/shear/data/shear_human_radius_r100.dat}
				%\pgfplotstabletranspose[columns=esr, numeric type]{\transD}{assets/shear/data/shear_human_radius_r125.dat}
