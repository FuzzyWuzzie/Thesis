		...
		\subsection{Lesion Detection Characterization}
			...
			\begin{figure}[!htb]
				...
				\begin{tikzpicture}
					...
					\end{axis}
				\end{tikzpicture}
				\caption[Numerical characterization of shear wave speed measured stiffness ratio with changing lesion radii in a visible human model]{}
