			...
			\begin{figure}[!htb]
				...
				\begin{tikzpicture}
					\begin{axis}[
						...
						\node (c) at (axis cs:1.75,3.6) {\includegraphics{assets/quasistatic/insets/inset_single.pdf}};
					\end{axis}
				\end{tikzpicture}
			...
			\begin{figure}[!htb]
				...
				\begin{tikzpicture}
					\begin{axis}[
						...
						\node (c) at (axis cs:0.5,3) {\includegraphics{assets/quasistatic/insets/inset_single.pdf}};
					\end{axis}
				\end{tikzpicture}
			...
			\begin{figure}[!htb]
				...
				\begin{tikzpicture}
					\begin{axis}[
						...
						\node (c) at (axis cs:0.5,2.5) {\includegraphics{assets/quasistatic/insets/inset_blur.pdf}};
					\end{axis}
				\end{tikzpicture}
			...
			\begin{figure}[!htb]
				...
				\begin{tikzpicture}
					\begin{axis}[
						...
						\node (c) at (axis cs:0.5,2) {\includegraphics{assets/quasistatic/insets/inset_blob.pdf}};
					\end{axis}
				\end{tikzpicture}
			...
			\begin{figure}[!htb]
				...
				\begin{tikzpicture}
					\begin{axis}[
						...
						\node (c) at (axis cs:0.5,2.25) {\includegraphics[width=0.072\columnwidth]{assets/quasistatic/insets/human.png}};
						\node (rect) at (axis cs:0.5,2.25) [draw,minimum width=0.072\columnwidth,minimum height=0.18\columnwidth]{};
					\end{axis}
				\end{tikzpicture}
