			...
			\begin{figure*}[!htb]
				...
				\subfloat[]{
					\begin{tikzpicture}[x=0.045\textwidth, y=0.045\textwidth, draw=black, text=black, fill=black]
						...
						\draw (6.125, 5.25) node{\scriptsize $\diameter L$};
	...
	\label{subsec:shear_results}
		...
		\label{subsubsec:shear_results_sample_wave_speed}
			...
			\begin{figure}[!htb]
				...
				\begin{tikzpicture}
					...
					\end{axis}
				\end{tikzpicture}
				\caption[Sample continuous surface plot of shear wave induced displacement]{Continuous surface plot of the shear wave induced axial displacement tracked through both time and distance from the transducer centreline. The sharp transition from negative to positive displacement marks the location of shear wave in time at any given location.}
			...
			\begin{figure}[!htb]
				...
				\begin{tikzpicture}
					\begin{axis}[
						...
						\draw[ultra thick, ->, draw=black] (axis cs:20,0.25) -- (axis cs:20,0.75);
						\draw[ultra thick, <-, draw=black] (axis cs:20,1.75) -- (axis cs:20,2.25);
						\node at (axis cs:20,1.25) {Lesion};
						\draw[ultra thick, draw=black, dashed] (axis cs:0,0.75) -- (axis cs:35,0.75);
						\draw[ultra thick, draw=black, dashed] (axis cs:0,1.75) -- (axis cs:35,1.75);
					\end{axis}
				\end{tikzpicture}
		...
		\subsection{Lesion Detection Characterization}
			...
			\begin{figure}[!htb]
				...
				\characterizationPic{%
					...
					\characterizationLegend{Lesion Radius}{r_{lesion}}%
						...
						{\SI{10.0}{\mm}}%
						{\SI{12.5}{\mm}}%
				}{spherical_radius}{0.6,1.5}{north west}{ymin=0,ymax=4.5}
			...
			\begin{figure}[!htb]
				...
				\begin{tikzpicture}
					\begin{axis}[
						...
						\addplot table {assets/shear/data/shear_radius_mse.dat};
						\node[anchor=north] at (axis cs:12.5,1.2) {\includegraphics{assets/insets/spherical_radius.pdf}};
					\end{axis}
				\end{tikzpicture}
			...
			\begin{figure}[!htb]
				...
				\characterizationPic{%
					...
					\characterizationLegend{Lesion Offset}{\Delta_{off}}%
						...
						{\SI{2.50}{\cm}}%
						{\SI{3.75}{\cm}}%
				}{offset}{3.125,0}{north west}{ymin=0,ymax=4.5}
			...
			\begin{figure}[!htb]
				...
				\begin{tikzpicture}
					\begin{axis}[
						...
						\node[anchor=north] at (axis cs:0,0.35) {\includegraphics{assets/insets/offset.pdf}};
					\end{axis}
				\end{tikzpicture}
			...
			\begin{figure}[!htb]
				...
				\characterizationPic{%
					...
					\characterizationLegend{Lesion Depth}{d}%
						...
						{\SI{6}{\cm}}%
						{\SI{8}{\cm}}%
				}{spherical_depth}{3.125,0}{north west}{ymin=0,ymax=4.5}
			...
			\begin{figure}[!htb]
				...
				\begin{tikzpicture}
					\begin{axis}[
						...
						\node[anchor=north] at (axis cs:2,0.75) {\includegraphics{assets/insets/spherical_depth.pdf}};
					\end{axis}
				\end{tikzpicture}
			...
			\begin{figure}[!htb]
				...
				\characterizationPic{%
					\characterizationPlots{esr}%
						{shear/data/shear_blur_r25.dat}%
						{shear/data/shear_blur_r50.dat}%
						{shear/data/shear_blur_r75.dat}%
				}{%
					\characterizationLegend{Blur Radius}{b_r}%
						{\SI{2.5}{\mm}}%
						{\SI{5.0}{\mm}}%
						{\SI{7.5}{\mm}}%
				}{blur_radius}{3.125,0}{north west}{ymin=0,ymax=4.5}
			...
			\begin{figure}[!htb]
				...
				\begin{tikzpicture}
					\begin{axis}[
						...
						\node[anchor=north] at (axis cs:9,0.016) {\includegraphics{assets/insets/blur_radius.pdf}};
					\end{axis}
				\end{tikzpicture}
			...
			\begin{figure}[!htb]
				...
				\characterizationPic{%
					\characterizationPlots{esr}%
						{shear/data/shear_cluster_dens_d10.dat}%
						{shear/data/shear_cluster_dens_d20.dat}%
						{shear/data/shear_cluster_dens_d30.dat}%
						{shear/data/shear_cluster_dens_d40.dat}%
				}{%
			...
			\begin{figure}[!htb]
				...
				\begin{tikzpicture}
					\begin{axis}[
						...
						\node[anchor=north] at (axis cs:40,0.7) {\includegraphics{assets/insets/cluster_density.pdf}};
					\end{axis}
				\end{tikzpicture}
			...
			\begin{figure}[!htb]
				...
				\characterizationPic{%
					\characterizationPlots{esr}%
						{shear/data/shear_cluster_radius_r05.dat}%
						{shear/data/shear_cluster_radius_r10.dat}%
						{shear/data/shear_cluster_radius_r15.dat}%
				}{%
					\characterizationLegend{Clustered Lesion Radii}{r_{bl}}%
						{\SI{0.5}{\mm}}%
						{\SI{1.0}{\mm}}%
						{\SI{1.5}{\mm}}%
				}{cluster_radius}{3.125,0.4}
			...
			\begin{figure}[!htb]
				...
				\begin{tikzpicture}
					\begin{axis}[
						...
						\node[anchor=north] at (axis cs:1.5,0.7) {\includegraphics{assets/insets/cluster_radius.pdf}};
					\end{axis}
				\end{tikzpicture}
			...
			\begin{figure}[!htb]
				...
				\characterizationPic{%
					...
					\characterizationLegend{Lesion Width}{\diameter S}%
						...
						{\SI{20}{\mm}}%
						{\SI{25}{\mm}}%
				}{human_width}{0.3,1}{north west}{ymin=0,ymax=4.75}
			...
			\begin{figure}[!htb]
				...
				\begin{tikzpicture}
					\begin{axis}[
						...
						bar width=28pt,
						ymajorgrids=true,
						xlabel={Lesion Width, $\diameter S$ (\si{\mm})},
						ylabel={Mean Squared Error},
						enlarge x limits=0.25,
						ymin=0,
						xtick=data,
						...
						cycle list name=BarColourPlotCycle]
						\addplot table {assets/shear/data/shear_human_radius_mse.dat};
						\node[anchor=north] at (axis cs:25.0,1) {\includegraphics{assets/insets/human_width.pdf}};
					\end{axis}
				\end{tikzpicture}
