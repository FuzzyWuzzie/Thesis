\chapter{Numerical Characterization of Acoustic Radiation Force Impulse Imaging}
	...
	\section{Methods}
		...
		\subsection{Temporal Finite-Element Model of Soft Tissue Deformation}
			...
			In order to simulate the dynamic tissue deformation generated by the acoustic impulse force, the time-dependent displacement field was calculated according to equation \ref{fea:time_deformation} where \note[KH]{Don't leave us hanging!}.
