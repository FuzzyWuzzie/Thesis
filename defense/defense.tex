...
\begin{document}
	...
	\begin{frame}
		...
		\begin{tikzpicture}
			...
			\onslide<3->{\draw[->] (-3.5cm, -1.75cm) -- (-3.5cm, -3.5cm) -- (-2.65cm, -3.5cm);
			\draw[->] (0cm, -1.75cm) -- (0, -3.2cm);
			\draw[->] (3.5cm, -1.75cm) -- (3.5cm, -3.5cm) -- (2.65cm, -3.5cm);}
		...
		\begin{frame}
			...
			\begin{center}
				...
				\begin{tabular}{r|c|cccc|cccc|cc}
					...
					\hline
					%\rowcolor{ExecusharesBlack}\color{ExecusharesWhite}This work & \cmark & \xmark & \cmark & \cmark & \cmark & \cmark & \cmark & \color{ExecusharesBlue}\textbf{?} & \color{ExecusharesBlue}\textbf{?} & \cmark & \cmark \\
